...
<link rel="stylesheet" type="text/css"href="{{asset('js/date/jquery.datetimepicker.css')}}"/>
...
<div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12">
                            <div class="form-group">
                               <div class="input-group"> 
                                <div class="input-group-addon borde_ex"><b><label class="a">Expediente</label></b></div>
                                    <input class="form-control borde_ex" type="text" name="numero_expediente" value="{{isset($expediente->numero_expediente) ?  $expediente->numero_expediente : old('numero_expediente')}}"
                                        required />
                                </div> 
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Habitación</label></b></div>
                                    <input type="text"  name="habitacion"value="{{isset($expediente->habitacion) ?  $expediente->habitacion : old('habitacion')}}"
                                    class="form-control  borde_ex"  />
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">F. Ingreso</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">DUI</label></b></div>
                                    <input type="text" {{--name="habitacion" value="isset($expediente->habitacion) ?  $expediente->habitacion : old('habitacion')--}}"
                                    class="form-control borde_ex" />
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">F. Nac.</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Edad</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-sm-12 col-md-8 col-xs-12 pa">                   
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Paciente</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Tel.</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-6 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Cel.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-sm-12 col-md-8 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Respon.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Empresa</label></b></div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Asegurado</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Carnet n°</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Dto.</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Poliza n°</label></b></div>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">DX ingreso</label></b></div>
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Codigo</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Formulario</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">C. No cub.</label></b></div> 
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">T. ingreso</label></b></div> 
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Ingreso por</label></b></div> 
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Eventos ing.</label></b></div> 
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor</label></b></div>
                                    <input type="text" name="dr" value="{{isset($expediente->dr) ? $expediente->dr: old('dr')}}"
                                        class="form-control borde_ex"  />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 2</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 3</label></b></div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 4</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 5</label></b></div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 6</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Doctor 7</label></b></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">DX egreso</label></b></div>
                        ...
                        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">F. Alta</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">O. Diagn.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Interv.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Cond Egre.</label></b></div>
                                        <select class="form-control borde_ex" name="cond_egre" id="cond_egre" >
                                            <option value="1"
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Enf. resp.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">Observ.</label></b></div>
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">H. Farm.</label></b></div>
                                    <input type="text" name="hora_far" id='check_time1'
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">H. Tel</label></b></div>
                                    <input type="text" name="hora_tel" id='check_time2'
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">H. Caja</label></b></div>
                                    <input type="text" name="hora_caj" id='check_time3'
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"><b><label class="a">R. Pagare</label></b></div>
                                    <input type="text"  name="rec_paga"   class="form-control borde_ex"
                        ...
                        <div class="col-lg-2 col-sm-2 col-md-2 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon borde_ex"> <b><label class="a">Estado</label></b></div>
                                    <select class="form-control borde_ex" name="estado" id="estado">
                                        <option value="Activo"
    ...
    <script src="{{asset('js/date/build/jquery.datetimepicker.full.js')}}"></script>
 ...
 $(function () {
    ...
    $('#check_time1 ,  #check_time2 , #check_time3').datetimepicker({
            step: 30,
            format:'H:i',
    ...
    $('#fecha_hora_ex ,  #fecha_hora_alta').datetimepicker({
            step: 30,
            format:'d.m.Y H:i',
