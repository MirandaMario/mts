...
<div class="row" style=" {{ config('constantes.FONT') }}">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pa">
        <div class="panel panel-primary">
            @if (isset($persona))
            <div class="panel-heading" style="font-size:150%; height: 40px;">Editar Proveedor</div>
            <div class="panel-body">
                {!!Form::model($persona,['method'=>'PATCH','route'=>['proveedor.update',$persona->idpersona], 'autocomplete="off"'])!!}
                @else
                <div class="panel-heading" style="font-size:150%; height: 40px;">Nuevo Proveedor</div>
                <div class="panel-body">
                    {!!Form::open(array('url'=>'proveedor','method'=>'POST','autocomplete'=>'off', 'id'=> 'proveedor_form'))!!}
                    @endif
                    {{Form::token()}}
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select id="departamento" name="departamento" class="form-control" >
                                        ...
                                        @foreach($departamentos as $dep)
                                        <option value="{{$dep->ID}}" {{(old('departamento') == $dep->ID)? "selected"  : ""}}>{{$dep->DepName}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12 pa">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nit"  value="{{isset($persona->nit) ?  $persona->nit : old('nit')}}"  class="form-control" placeholder="NIT..." />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="tipo_contribuyente" id="tipo_contribuyente">
                                        <option value="Pequeño" {{ isset($persona->tipo_contribuyente) ? $persona->tipo_contribuyente == 'Pequeño' ? 'selected' : ""  : old('tipo_contribuyente') == "Pequeño" ? "selected" : ""}}>Pequeño</option>
                                        <option value="Mediano" {{ isset($persona->tipo_contribuyente) ? $persona->tipo_contribuyente == 'Mediano' ? 'selected' : ""  : old('tipo_contribuyente') == "Mediano" ? "selected" : ""}}>Mediano</option>
                                        <option value="Grande"  {{ isset($persona->tipo_contribuyente) ? $persona->tipo_contribuyente == 'Grande' ? 'selected' : ""  : old('tipo_contribuyente') == "Grande" ? "selected" : ""}}>Grande</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="forma_pago" id="forma_pago">
                                        <option value="Credito" {{ isset($persona->iva) ? $persona->forma_pago == 'Credito' ? 'selected' : ""  : old('forma_pago') == "Credito" ? "selected" : ""}}>Crédito</option>
                                        <option value="Contado" {{ isset($persona->iva) ? $persona->forma_pago == 'Contado' ? 'selected' : ""  : old('forma_pago') == "Contado" ? "selected" : ""}}>Contado</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="estado" id="estado">
                                        <option value="Activo"   {{ isset($persona->estado) ? $persona->estado == 'Activo' ? 'selected' : ""  : old('estado') == "Activo" ? "selected" : ""}}>Activo</option>
                                        <option value="Inactivo" {{ isset($persona->estado) ? $persona->estado == 'Inactivo' ? 'selected' : ""  : old('estado') == "Inactivo" ? "selected" : ""}}>Inactivo</option>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="contacto3"
                                        value="{{isset($persona->contacto3) ? $persona->contacto2 : old('contacto3')}}"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 col-md-6 col-xs-12 pa">
                            @if (isset($persona))
                                ...
                                <a href="{{ url('/proveedor') }}"><button class="btn btn-primary btn-sm m-t-10"
